...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Software\Web Development\Mano work\React+Django+Postgres Todo app\my_auth\authentication\authenticate\backend\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Software\Web Development\Mano work\React+Django+Postgres Todo app\my_auth\authentication\authenticate\backend\venv\Scripts\deactivate.nu'
